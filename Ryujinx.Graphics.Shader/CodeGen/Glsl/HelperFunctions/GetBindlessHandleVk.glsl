...
layout (set = 7, binding = 0) uniform image3D bindless_images3D[];
layout (set = 7, binding = 0) uniform imageCube bindless_imagesCube[];
layout (set = 7, binding = 0) uniform image1DArray bindless_images1DArray[];
layout (set = 7, binding = 0) uniform image2DArray bindless_images2DArray[];
