...
namespace Ryujinx.Graphics.Shader.Translation
{
    public static class Translator
    {
            ...
            byte clipDistancesWritten)
        {
            ...
            HelperFunctionManager hfm = new HelperFunctionManager(funcs, definitions.Stage);
            ...
            out int initializationOperations)
        {
            ...
            {
                EmitterContext context = new EmitterContext(translatorContext, resourceManager, program, index != 0);
