...
namespace Ryujinx.Horizon.Sdk.Nifm.Detail
{
    interface IGeneralService : IServiceObject
    {
        ...
        Result SetNetworkProfile(out Uuid arg0, in NetworkProfileData arg1);
        ...
        Result CreateTemporaryNetworkProfile(out INetworkProfile arg0, out Uuid arg1, in NetworkProfileData arg2);
        ...
        Result IsAnyInternetRequestAccepted(out bool arg0, in ClientId arg1);
        Result IsAnyForegroundRequestAccepted(out bool arg0);
        Result PutToSleep();
        Result WakeUp();
        Result GetSsidListVersion(out SsidListVersion arg0);
        Result SetExclusiveClient(in ClientId arg0);
        Result GetDefaultIpSetting(out IpSettingData arg0);
        Result SetDefaultIpSetting(in IpSettingData arg0);
