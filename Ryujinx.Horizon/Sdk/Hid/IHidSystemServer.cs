...
namespace Ryujinx.Horizon.Sdk.Hid
{
    interface IHidSystemServer : IServiceObject
    {
        ...
        Result AcquireHomeButtonEventHandle(out int arg0, AppletResourceUserId arg1, ulong pid);
        Result ActivateHomeButton(AppletResourceUserId arg0, ulong pid);
        Result AcquireSleepButtonEventHandle(out int arg0, AppletResourceUserId arg1, ulong pid);
        Result ActivateSleepButton(AppletResourceUserId arg0, ulong pid);
        Result AcquireCaptureButtonEventHandle(out int arg0, AppletResourceUserId arg1, ulong pid);
        Result ActivateCaptureButton(AppletResourceUserId arg0, ulong pid);
        ...
        Result ActivateNfc(uint arg0, bool arg1, AppletResourceUserId arg2, ulong pid);
        ...
        Result ActivateIrSensor(uint arg0, bool arg1, AppletResourceUserId arg2, ulong pid);
        Result GetIrSensorState(uint arg0, out long arg1, AppletResourceUserId arg2, ulong pid);
        Result GetXcdHandleForNpadWithIrSensor(uint arg0, out DeviceHandle arg1, AppletResourceUserId arg2, ulong pid);
        Result ActivateNpadSystem(uint arg0);
        Result ApplyNpadSystemCommonPolicy(AppletResourceUserId arg0, ulong pid);
        Result EnableAssigningSingleOnSlSrPress(AppletResourceUserId arg0, ulong pid);
        Result DisableAssigningSingleOnSlSrPress(AppletResourceUserId arg0, ulong pid);
        Result GetLastActiveNpad(out uint arg0);
        Result GetNpadSystemExtStyle(out long arg0, out long arg1, uint arg2);
        Result ApplyNpadSystemCommonPolicyFull(AppletResourceUserId arg0, ulong pid);
        ...
        Result SetNpadPlayerLedBlinkingDevice(AppletResourceUserId arg0, uint arg1, DeviceType arg2, ulong pid);
        Result SetSupportedNpadStyleSetAll(AppletResourceUserId arg0, ulong pid);
        ...
        Result SetNpadSystemExtStateEnabled(AppletResourceUserId arg0, bool arg1, ulong pid);
        ...
        Result ActivateUniquePad(AppletResourceUserId arg0, UniquePadId arg1, ulong pid);
        Result AcquireUniquePadConnectionEventHandle(out int arg0);
        Result GetUniquePadIds(out long arg0, Span<UniquePadId> arg1);
        Result AcquireJoyDetachOnBluetoothOffEventHandle(out int arg0, AppletResourceUserId arg1, ulong pid);
        ...
        Result IsSixAxisSensorAccurateUserCalibrationSupported(out bool arg0, UniqueSixAxisSensorHandle arg1, AppletResourceUserId arg2, ulong pid);
        Result StartSixAxisSensorAccurateUserCalibration(UniqueSixAxisSensorHandle arg0, AppletResourceUserId arg1, ulong pid);
        Result CancelSixAxisSensorAccurateUserCalibration(UniqueSixAxisSensorHandle arg0, AppletResourceUserId arg1, ulong pid);
        Result GetSixAxisSensorAccurateUserCalibrationState(out SixAxisSensorAccurateUserCalibrationState arg0, UniqueSixAxisSensorHandle arg1, AppletResourceUserId arg2, ulong pid);
        Result GetHidbusSystemServiceObject(out IHidbusSystemServer arg0);
        Result SetFirmwareHotfixUpdateSkipEnabled(bool arg0);
        Result InitializeUsbFirmwareUpdate(AppletResourceUserId arg0, int arg1, ulong arg2, ulong pid);
        Result FinalizeUsbFirmwareUpdate(AppletResourceUserId arg0, ulong pid);
        Result CheckUsbFirmwareUpdateRequired(AppletResourceUserId arg0, out long arg1, ulong pid);
        Result StartUsbFirmwareUpdate(AppletResourceUserId arg0, ulong pid);
        Result GetUsbFirmwareUpdateState(AppletResourceUserId arg0, out FirmwareUpdateState arg1, out int arg2, out int arg3, ulong pid);
        ...
        Result IsFirmwareAvailableForNotification(out bool arg0, int arg1, UniquePadId arg2, AppletResourceUserId arg3, ulong pid);
        ...
        Result SetButtonConfigEmbedded(in ButtonConfigEmbedded arg0);
        Result SetButtonConfigFull(in ButtonConfigFull arg0, Address arg1);
        Result SetButtonConfigRight(in ButtonConfigRight arg0, Address arg1);
        ...
        Result IsDefaultButtonConfigEmbedded(out bool arg0, in ButtonConfigEmbedded arg1);
        Result IsDefaultButtonConfigFull(out bool arg0, in ButtonConfigFull arg1);
        Result IsDefaultButtonConfigLeft(out bool arg0, in ButtonConfigLeft arg1);
        Result IsDefaultButtonConfigRight(out bool arg0, in ButtonConfigRight arg1);
        ...
        Result SetHidButtonConfigEmbedded(in ButtonConfigEmbedded arg0, UniquePadId arg1);
        Result SetHidButtonConfigFull(in ButtonConfigFull arg0, UniquePadId arg1);
        Result SetHidButtonConfigLeft(in ButtonConfigLeft arg0, UniquePadId arg1);
        Result SetHidButtonConfigRight(in ButtonConfigRight arg0, UniquePadId arg1);
        ...
        Result SetButtonConfigStorageEmbedded(in ButtonConfigEmbedded arg0, in StorageName arg1, int arg2);
        Result SetButtonConfigStorageFull(in ButtonConfigFull arg0, in StorageName arg1, int arg2);
        Result SetButtonConfigStorageLeft(in ButtonConfigLeft arg0, in StorageName arg1, int arg2);
        Result SetButtonConfigStorageRight(in ButtonConfigRight arg0, in StorageName arg1, int arg2);
        Result SetButtonConfigLeft(in ButtonConfigLeft arg0, Address arg1);
    }
}
